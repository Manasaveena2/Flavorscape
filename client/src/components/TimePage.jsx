...
//   const apiUrl = `https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/complexSearch?maxReadyTime=${time}&addRecipeNutrition=true&number=100`;
...
//     const fetchRecipes = async (maxTime) => {
//       try {
//         const response = await axios.get(`https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/complexSearch?number=100&addRecipeNutrition=true&maxReadyTime=${maxTime}`, {
//           headers: {
//             'x-rapidapi-key': '2cf363e464msh40119dd71827212p1759f2jsn9f2d6345d821',
//             'x-rapidapi-host': 'spoonacular-recipe-food-nutrition-v1.p.rapidapi.com',
//           },
...
const TimePage = () => {
  ...
  const apiUrl = `https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/complexSearch?maxReadyTime=${category}&addRecipeNutrition=true&number=100`;

  // Fetch the recipes from the API
  const fetchRecipes = async (time) => {
    try {
      const response = await axios.get(
        `https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/complexSearch?number=100&addRecipeNutrition=true&maxReadyTime=${time}`, 
        {
          headers: {
            'x-rapidapi-key': apiKey,
            'x-rapidapi-host': 'spoonacular-recipe-food-nutrition-v1.p.rapidapi.com',
